       ...
       // POST: Klientas/Create
        ...
        public ActionResult Create(Klientas collection)
        {
            try
            {
                ...
                Klientas tmpKlientas = klientasRepository.getKlientas(collection.Tel_numeris);
                if (tmpKlientas.Tel_numeris != null)
                {
                    ModelState.AddModelError("Tel_numeris", "Klientas su tokiu telefono numeriu jau užregistruotas");
     ...
     //   POST: Klientas/Delete/5
        ...
        public ActionResult Delete(string id, FormCollection collection)
        {
            try
            {
                ...
                {
                    naudojama = true;
                    ViewBag.naudojama = "Negalima pašalinti klientas yra įvykdęs užsakymų";
                    return View(klientasRepository.getKlientas(id));
                }

...
namespace AutoNuoma.Repos
{
    ...
    {
        public List<UzsakymasListViewModel> getSutartys()
        {
            List<UzsakymasListViewModel> sutartys = new List<UzsakymasListViewModel>();
            ...
            {
                sutartys.Add(new UzsakymasListViewModel
                {
        ...
        public UzsakymasEditViewModel getSutartis(int nr)
        {
            UzsakymasEditViewModel sutartis = new UzsakymasEditViewModel();
            string conn = ConfigurationManager.ConnectionStrings["MysqlConnection"].ConnectionString;
            MySqlConnection mySqlConnection = new MySqlConnection(conn);
        ...
        public bool updateSutartis(UzsakymasEditViewModel sutartis)
        {
            string conn = ConfigurationManager.ConnectionStrings["MysqlConnection"].ConnectionString;
            MySqlConnection mySqlConnection = new MySqlConnection(conn);
        ...
        public bool addSutartis(UzsakymasEditViewModel sutartis)
        {
            string conn = ConfigurationManager.ConnectionStrings["MysqlConnection"].ConnectionString;
            MySqlConnection mySqlConnection = new MySqlConnection(conn);
